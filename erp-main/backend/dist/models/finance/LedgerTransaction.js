...
const LedgerTransactionSchema = new mongoose_1.Schema({
    accountId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Account' },
    projectId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Project' },
    journalEntryId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'JournalEntry' },
...
exports.default = mongoose_1.default.model('LedgerTransaction', LedgerTransactionSchema);
